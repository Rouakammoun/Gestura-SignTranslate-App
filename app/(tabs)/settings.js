...
const SettingsScreen = () => {
  ...
  const handleSubmit = async () => {
    const API_URL = 'http://192.168.1.6:5000/update-user/1';
  
    console.log("URL utilisée :", API_URL); // Debug 0
    console.log("Envoi des données :", userData); // Debug 1
    ...
    try {
      ...
      console.log("Statut de la réponse :", response.status); // Debug 2
      ...
      console.log("Réponse du serveur :", result); // Debug 3
    ...
    <View style={{ flex: 1 }}>
      <ScrollView style={styles.container}>
        <View style={styles.header}>
          ...
          <Image
            source={require('../../assets/images/taswirti.jpg')} // Replace with your local image or use a valid URL
